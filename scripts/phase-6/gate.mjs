...
const out = path.resolve(arg('out') ?? 'artifacts/phase-6-gate');
...
try{
 ...
 await run('browser','npx',['playwright','test','tests/browser/prototype.spec.ts','tests/browser/phase2.spec.ts','tests/browser/phase3.spec.ts','tests/browser/phase4.spec.ts','tests/browser/phase5.spec.ts','tests/browser/phase6.spec.ts','--retries=0'],{NEPTUNE_BASE_URL:'http://127.0.0.1:4173/',NEPTUNE_BROWSER_REPORT:path.join(out,'browser.json')});
