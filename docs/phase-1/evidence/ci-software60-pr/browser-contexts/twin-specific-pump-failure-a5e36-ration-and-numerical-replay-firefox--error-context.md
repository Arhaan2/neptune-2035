...
Call log:
  - waiting for getByRole('button', { name: 'Restore selected asset', exact: true })
    - locator resolved to <button>Restore selected asset</button>
...
- main [ref=e3]:
  ...
  - generic [ref=e25]:
    ...
    - generic [ref=e85]:
      ...
      - generic [ref=e122]:
        ...
        - generic [ref=e127]:
          ...
          - combobox "Simulation speed" [ref=e128] [cursor=pointer]:
            ...
            - option "20×"
            - option "60×"
        - button "Step 10s" [active] [ref=e129] [cursor=pointer]
      ...
      - status [ref=e136]: "Checkpoint saved locally at 10s. Progress after this checkpoint may be lost on interruption. Last successful local checkpoint: 10s."
      - generic [ref=e137]:
        - text: trip recorded at 0s for platform-001/module-02/pump-duty.
      ...
      - generic [ref=e142]:
        ...
        - generic [ref=e149]:
          - generic [ref=e150]: 0s
          - generic [ref=e151]: 10s · no interpolation of physical fields
    - complementary [ref=e152]:
      - generic [ref=e153]: OPERATE / SELECTED ASSET
      - heading "pump duty" [level=2] [ref=e154]
      - code [ref=e155]: platform-001/module-02/pump-duty
      - generic [ref=e156]: failed · simulated
      - generic [ref=e157]:
        - term [ref=e158]: Envelope (W × H × D)
        - definition [ref=e159]: 1.2 × 1.2 × 0.8 m
        - term [ref=e160]: Operational mass
        - definition [ref=e161]: 180 kg
        - term [ref=e162]: Catalog / evidence
        - definition [ref=e163]: equipment-v2 · assumed
        - term [ref=e164]: Failure domain
        - definition [ref=e165]:
          - button "shore/bus" [ref=e166] [cursor=pointer]
      - group [ref=e167]:
        - generic "Ratings and ports" [ref=e168] [cursor=pointer]
      - heading "Module operating point" [level=3] [ref=e169]
      - generic [ref=e170]:
        - term [ref=e171]: Technical / seawater flow
        - definition [ref=e172]: 0 / 66.37 L/s
        - term [ref=e173]: Hydraulic pressure
        - definition [ref=e174]: 0 kPa
        - term [ref=e175]: Coolant / residual air
        - definition [ref=e176]: 30.72 / 25.26 °C
        - term [ref=e177]: Stored battery energy
        - definition [ref=e178]: 400 kWh
        - term [ref=e179]: Instantaneous / energy PUE
        - definition [ref=e180]: 1.076 / 1.076
      - generic [ref=e181]:
        - button "Trip selected asset" [ref=e182] [cursor=pointer]
        - button "Restore selected asset" [ref=e183] [cursor=pointer]
        - button "Inspect duty pump" [ref=e184] [cursor=pointer]
      - heading "Recorded boundary commands" [level=3] [ref=e185]
      - generic [ref=e186]:
        - button "Full load" [ref=e187] [cursor=pointer]
        - button "Seawater 32°C" [ref=e188] [cursor=pointer]
        - button "Foul exchanger" [ref=e189] [cursor=pointer]
        - button "Lose feeder" [ref=e190] [cursor=pointer]
        - button "Restore feeder" [ref=e191] [cursor=pointer]
        - button "Isolate module" [ref=e192] [cursor=pointer]
        - button "Return module" [ref=e193] [cursor=pointer]
        - button "Lose cluster link" [ref=e194] [cursor=pointer]
        - button "Lose external link" [ref=e195] [cursor=pointer]
      - button "Play pump-failure cinematic" [ref=e196] [cursor=pointer]
      - heading "Causal event log" [level=3] [ref=e197]
      - list [ref=e198]:
        - listitem [ref=e199]:
          - generic [ref=e200]: 0s · warning
          - button "platform-001/module-02" [ref=e201] [cursor=pointer]
          - paragraph [ref=e202]: Technical coolant flow lost; heat accumulating in bulk thermal node
        - listitem [ref=e203]:
          - generic [ref=e204]: 0s · command
          - button "platform-001/module-02/pump-duty" [ref=e205] [cursor=pointer]
          - paragraph [ref=e206]: trip; 1 module(s) in dependency scope
        - listitem [ref=e207]:
          - generic [ref=e208]: 0s · command
          - button "shore/grid" [ref=e209] [cursor=pointer]
          - paragraph [ref=e210]: workload = 1 fraction; 8 module(s) in dependency scope
      - group [ref=e211]:
        - generic "Supporting paths & connections" [ref=e212] [cursor=pointer]
      - heading "Inspect the evidence" [level=3] [ref=e213]
      - generic [ref=e214]:
        - button "Data & replay" [ref=e215] [cursor=pointer]
        - button "Constraints & sources" [ref=e218] [cursor=pointer]
      - paragraph [ref=e219]: Residuals · electrical 0 W · thermal -0 W · solver 236 msNormalized · electrical 0.00e+0 · thermal -2.34e-17
      - paragraph [ref=e221]: Technical coolant flow lost; heat accumulating in bulk thermal node
  - generic [ref=e222]:
    - generic [ref=e223]: Arhaan Aggarwal · Calibration / physical validation pending
    - generic [ref=e224]:
      - generic [ref=e225] [cursor=pointer]: Import project
      - combobox "Export artifact" [ref=e226] [cursor=pointer]:
