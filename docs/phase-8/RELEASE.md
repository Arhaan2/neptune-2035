...
node scripts/phase-8/experiments.mjs --campaigns=/absolute/evidence/historical-inputs --out=/absolute/evidence/experiments
node scripts/phase-8/gate.mjs --campaigns=/absolute/evidence/historical-inputs --out=/absolute/evidence/local
```
