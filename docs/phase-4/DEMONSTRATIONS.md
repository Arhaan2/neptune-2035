...
4. Open **Recorded definition, assumptions and evidence** to inspect identities, thresholds, inputs and coverage; open **Disturbance footprint and experiment assumptions** for affected equipment and capacity. **Export artifact → Project JSON** exports the real result. Import it or reload and choose **Recover saved checkpoint** to retain its complete report.
