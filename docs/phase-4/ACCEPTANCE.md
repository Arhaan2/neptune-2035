...
- Independent Verification then reproduced left-held warmup qualification, unavailable-terminal comparison, endpoint-delta labeling and recovery-reference defects. These are blocking until independently rechecked. Earlier footprint and four boundary repairs are recorded in `FIXES.md`.
