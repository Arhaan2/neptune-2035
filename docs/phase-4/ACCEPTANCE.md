...
The first full frozen local gate at377ce40 passed498/498 unit/integration tests (30 files, both real telemetry integrations) and37 browser journeys with2 historical exclusions, no failures/flaky/retries. Its source CI nevertheless failed the three pending signature-execution journeys; see [CI investigation and repair](CI-REPAIR.md). The repaired focused gate atcbb6922 passes137 tests, including13 new lookup cases and2 complete long-worker trajectory regressions. Full gates must be repeated on the repaired frozen candidate.
