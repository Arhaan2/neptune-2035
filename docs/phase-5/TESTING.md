...
| D zero/insufficient/exact/sufficient, partial, tie and upstream bottlenecks | `phase5-capacity.test.ts`, independent exhaustive-subset oracle,36 bounded multi-resource combinations (3 native loads × 4 source ratings × 3 tie ratings); real shared donor partial99; UI140kW bottleneck99 vs160; installed standby recipient63/64kW and native donor125/126kW boundaries | Passed repaired combined/Chromium |
