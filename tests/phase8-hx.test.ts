...
describe('P8-N04 V8-05 independently referenced near-equal counterflow heat', () => {
  it.each([
    { label: 'outside equal-rate approximation branch', seawaterFlowM3S: 0.0010000000110000002, heatW: Number('10000.0000275000002227'), toleranceW: 1e-6, technicalOutletK: 303.1499999724999, seawaterOutletK: 303.14999991749994 },
    { label: 'inside declared equal-rate approximation branch', seawaterFlowM3S: 0.001000000009, heatW: Number('10000.0000224999998144'), toleranceW: 1e-4, technicalOutletK: 303.1499999775, seawaterOutletK: 303.1499999325 },
